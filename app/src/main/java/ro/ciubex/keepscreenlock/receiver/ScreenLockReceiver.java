...
/**
 * This broadcast receiver is used at lock the screen.
 *
 * @author Claudiu Ciobotariu
 *
 */
public class ScreenLockReceiver extends BroadcastReceiver {
	private static final String TAG = ScreenLockReceiver.class.getName();
	...
	public void onReceive(Context context, Intent intent) {
		...
		Log.d(TAG, "ScreenLockReceiver.onReceive(" + action + ")");
		if (LOCK_SCREEN.equals(action)) {
			...
			if (mainApplication != null) {
				mainApplication.executeLockScreen(false);
			}
		}
	}
}
